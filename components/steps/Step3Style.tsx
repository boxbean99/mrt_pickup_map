    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-100 flex gap-2">
        ...
        <button
          onClick={onNext}
          disabled={!style}
          className="flex-[2] py-3 rounded-lg text-sm font-semibold transition-colors disabled:bg-gray-200 disabled:text-gray-400 disabled:cursor-not-allowed bg-red-600 hover:bg-red-700 text-white"
        >
          상품 추천 보기 →
        </button>
      </div>
